...
/// KRİTİK: Face ID cihazında Info.plist'te NSFaceIDUsageDescription yoksa evaluatePolicy
/// çöker/sessizce asılı kalır → runtime'da Bundle.main'den kontrol edip GÖRÜNÜR hata veririz.
...
public class BiometricPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    @objc func authenticate(_ call: CAPPluginCall) {
        ...
        // 1) Kullanılabilirlik guard'ı — başarısızlık MUTLAKA reject olarak JS'e gider.
        ...
        // 2) Face ID + eksik NSFaceIDUsageDescription = çöker/asılı kalır → görünür hata.
        ...
        // 3) Değerlendirme: TAZE context (canEvaluate context'ini YENİDEN KULLANMA — bilinen tuzak).
        //    Fallback butonu GİZLİ (""): Android BIOMETRIC_WEAK davranışının birebiri.
        let ctx = LAContext()
