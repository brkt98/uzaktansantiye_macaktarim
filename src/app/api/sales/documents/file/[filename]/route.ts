...
export async function GET(
  ...
  try {
    ...
    const baseDir = path.join(UPLOAD_DIR, "sales-documents");
    ...
    // ?size=thumb → küçük (400px webp) sürümü servis et (varsa; PDF/diğerlerinde fallback).
    let isThumb = false;
    ...
    console.error("SalesDocument file serve error:", err);
