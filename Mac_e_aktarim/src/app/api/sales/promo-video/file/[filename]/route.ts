...
export async function GET(
  ...
  try {
    ...
    const filePath = path.join(UPLOAD_DIR, "sales-promo", filename);
    const resolvedPath = path.resolve(filePath);
    const resolvedBase = path.resolve(path.join(UPLOAD_DIR, "sales-promo"));
    ...
    console.error("promo-video serve err", err);
